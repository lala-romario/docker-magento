...
class Interceptor extends \Magento\CatalogInventory\Model\Indexer\Stock implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CatalogInventory\Model\Indexer\Stock\Action\Row $productStockIndexerRow, \Magento\CatalogInventory\Model\Indexer\Stock\Action\Rows $productStockIndexerRows, \Magento\CatalogInventory\Model\Indexer\Stock\Action\Full $productStockIndexerFull, ?\Magento\Framework\Indexer\CacheContext $cacheContext = null)
    {
        $this->___init();
        parent::__construct($productStockIndexerRow, $productStockIndexerRows, $productStockIndexerFull, $cacheContext);
    }
