...
class Interceptor extends \Magento\Customer\Block\Account\AuthenticationPopup implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, array $data = [], ?\Magento\Framework\Serialize\Serializer\Json $serializer = null, array $layoutProcessors = [])
    {
        $this->___init();
        parent::__construct($context, $data, $serializer, $layoutProcessors);
    }
