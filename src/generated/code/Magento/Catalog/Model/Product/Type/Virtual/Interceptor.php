<?php
namespace Magento\Catalog\Model\Product\Type\Virtual;

/**
 * Interceptor class for @see \Magento\Catalog\Model\Product\Type\Virtual
 */
class Interceptor extends \Magento\Catalog\Model\Product\Type\Virtual implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($catalogProductOption, $eavConfig, $catalogProductType, $eventManager, $fileStorageDb, $filesystem, $coreRegistry, $logger, $productRepository, $serializer, $uploaderFactory, $cache);
    }
