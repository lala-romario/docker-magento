...
class Interceptor extends \Magento\SalesGraphQl\Model\Resolver\ProductResolver implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CatalogGraphQl\Model\ProductDataProvider $productDataProvider, \Psr\Log\LoggerInterface $logger)
    {
        $this->___init();
        parent::__construct($productDataProvider, $logger);
    }
