...
class Interceptor extends \Magento\SalesGraphQl\Model\Resolver\Reorder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Sales\Model\Reorder\Reorder $reorder, \Magento\Sales\Model\OrderFactory $orderFactory, \Magento\Framework\Lock\LockManagerInterface $lockManager)
    {
        $this->___init();
        parent::__construct($reorder, $orderFactory, $lockManager);
    }
