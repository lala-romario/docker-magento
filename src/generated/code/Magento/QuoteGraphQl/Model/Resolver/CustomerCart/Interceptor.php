...
class Interceptor extends \Magento\QuoteGraphQl\Model\Resolver\CustomerCart implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Quote\Model\Cart\CustomerCartResolver $customerCartResolver, \Magento\QuoteGraphQl\Model\Cart\UpdateCartCurrency $updateCartCurrency)
    {
        $this->___init();
        parent::__construct($customerCartResolver, $updateCartCurrency);
    }
