...
class Interceptor extends \Magento\CatalogInventoryGraphQl\Model\Resolver\QuantityResolver implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Api\ProductRepositoryInterface $productRepositoryInterface, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\QuoteGraphQl\Model\CartItem\ProductStock $productStock)
    {
        $this->___init();
        parent::__construct($productRepositoryInterface, $scopeConfig, $productStock);
    }
