...
class Interceptor extends \Magento\Quote\Model\CustomerManagement implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Customer\Api\CustomerRepositoryInterface $customerRepository, \Magento\Customer\Api\AddressRepositoryInterface $customerAddressRepository, \Magento\Customer\Api\AccountManagementInterface $accountManagement, \Magento\Customer\Api\Data\AddressInterfaceFactory $customerAddressFactory, \Magento\Customer\Api\Data\RegionInterfaceFactory $regionFactory, ?\Magento\Framework\Validator\Factory $validatorFactory = null, ?\Magento\Customer\Model\AddressFactory $addressFactory = null)
    {
        $this->___init();
        parent::__construct($customerRepository, $customerAddressRepository, $accountManagement, $customerAddressFactory, $regionFactory, $validatorFactory, $addressFactory);
    }
