<?php
namespace Magento\TwoFactorAuth\Controller\Adminhtml\Duo\VerifyIdentity;

/**
 * Interceptor class for @see \Magento\TwoFactorAuth\Controller\Adminhtml\Duo\VerifyIdentity
 */
class Interceptor extends \Magento\TwoFactorAuth\Controller\Adminhtml\Duo\VerifyIdentity implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $session, $pageFactory, $userConfigManager, $tfa, $tokenVerifier, $duoSecurity, $tfaProviderSession);
    }
