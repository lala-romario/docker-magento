<?php
namespace Magento\TwoFactorAuth\Model\TfaProviderSession;

/**
 * Proxy class for @see \Magento\TwoFactorAuth\Model\TfaProviderSession
 */
class Proxy extends \Magento\TwoFactorAuth\Model\TfaProviderSession implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * Proxied instance
     *
     * @var \Magento\TwoFactorAuth\Model\TfaProviderSession
     */
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\TwoFactorAuth\\Model\\TfaProviderSession', $shared = true)
    {
     ...
     *
     * @return \Magento\TwoFactorAuth\Model\TfaProviderSession
     */
    ...
    {
        return $this->_getSubject()->isNewProviderConfigurationAllowed();
    }
    ...
    {
        $this->_getSubject()->setNewProviderConfigurationAllowed($status);
    }
    ...
    {
        return $this->_getSubject()->getProviderToConfigure();
    }
    ...
    {
        $this->_getSubject()->setProviderToConfigure($provider);
    }
